...
A lot of intellectual tasks could be performed by Symbol-mind using provided means. Some of the tasks may use *Admissibility Base* (AB) featured in accompanying examples. AB is a simple database for rule based querying specifically patterned S-expression data. It could be used to formalize and simplify choosing the right options among a variety of alternatives.
